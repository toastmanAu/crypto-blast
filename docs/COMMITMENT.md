...
| 25 | `mask.data` (terrain occupancy, `width*height` bytes, 1=solid) | bytes |
...
| **Phase 1 — full match** | `verifier/bench` `replay` | **55,010,368 (52.5M)** | `create_world(1234,1280,720)` + `step_world ×304` + `serialize_world` + blake2b-256, replaying the demo tape, self-gated on `0xc68550fd…f544`. |
